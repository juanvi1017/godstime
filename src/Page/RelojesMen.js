                ...
                <div className="col-md-12 product-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Relojes Hombre</li>
                        </ol>
                    </nav>
                </div>
                <div className="col-md-12 title-product-store">
                    <p className='title-product'>Relojes para hombre</p>
                    <p>Aprovecha nuestros precios en relojería para hombre y no pierdas la oportunidad de tener tu reloj favorito.</p>
                </div>
                                ...
                                productsData.map((product) => {
                                    return (
                                        <div className='product-item col-md-3' key={product.id}>
                                            ...
                                            <Link to={`/products/Relojes Hombre/${product.id}`}>
